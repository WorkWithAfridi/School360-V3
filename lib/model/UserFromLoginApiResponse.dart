...
class UserFromLoginApiResponse {
  UserFromLoginApiResponse({
      bool? isSuccess, 
      String? message, 
  ...
  UserFromLoginApiResponse.fromJson(dynamic json) {
...
UserFromLoginApiResponse copyWith({  bool? isSuccess,
  String? message,
  StudentInfo? studentInfo,
  ContactInfo? contactInfo,
}) => UserFromLoginApiResponse(  isSuccess: isSuccess ?? _isSuccess,
